    ...
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="print-only print-header" style="display: none;">
                ...
                <h3>Reporte de Telas más Reservadas</h3>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <h4 class="card-title">Telas más Reservadas</h4>
                                <div class="no-print">
                                    <button class="btn btn-primary btn-sm me-2" onclick="handlePrint()">
                            ...
                            <div class="table-responsive">
                                <table class="table table-dark table-hover sortable" id="dataTable">
                                    ...
                                    <tbody>
                                        <?php if (!empty($telaConMasReservas)): ?>
                                            <?php foreach ($telaConMasReservas as $tela): ?>
                                                <tr>
                                                    <td><?= esc($tela['nombre']) ?></td>
                                                    <td><?= esc($tela['total_reservas']) ?></td>
                                                    <td><?= esc($tela['calidad']) ?></td>
                                                    <td><?= number_format($tela['precio'], 2) ?> Bs</td>
                                                    <td><?= esc($tela['usuarios_unicos']) ?></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        <?php else: ?>
                                            <tr>
        ...
        <footer class="footer no-print">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
                <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">
                    Copyright © <?= date('Y') ?> Sastreria Jimenez
                </span>
            </div>
        </footer>
    </div>
...
function updateTable() {
    ...
    // Mostrar datos filtrados y paginados
...
function handlePrint() {
    ...
    printFrame.contentDocument.write(`
        <html>
            <head>
                <title>Reporte de Telas - Sastrería Jimenez</title>
                <style>
