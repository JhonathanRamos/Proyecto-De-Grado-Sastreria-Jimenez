...
<head>
 ...
 <link rel="stylesheet" type="text/css" href="<?= base_url('css/error.css') ?>">
  <title>Inicio</title>
</head>

<body>

<!-- CODE PEN https://codepen.io/Jhonathan-David-Ramos-Jimenez/pen/PorXybJ-->
...
<script src="<?= base_url('js/error.js') ?>"></script>
</body>
</html>
