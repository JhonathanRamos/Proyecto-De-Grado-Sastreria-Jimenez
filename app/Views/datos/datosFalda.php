        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="card-title">Medidas Falda</h1>

                            <!-- Formulario para el buscador y filtros -->
                            <form method="GET" action="<?= site_url('datosFalda'); ?>">
                                <div class="row mb-3">
                                    <!-- Campo de búsqueda -->
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-3">
                                        <select name="orden" class="form-control">
                                            ...
                                            <option value="antiguos" <?= ($orden ?? '') === 'antiguos' ? 'selected' : ''; ?>>
                                                Antiguos
                                            </option>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <a href="<?= site_url('datosFalda'); ?>" class="btn btn-secondary">Limpiar</a>
                                    </div>
                                </div>
                            </form>
                                    ...
                                    <tbody>
                                        <?php if (!empty($faldas)): ?>
                                            <?php foreach ($faldas as $Falda): ?>
                                                <tr>
                                                    <td><?= esc($Falda['idCliente']); ?></td>
                                                    <td><?= esc($Falda['nombre_completo']); ?></td>
                                                    <td><?= esc($Falda['largo']); ?></td>
                                                    <td><?= esc($Falda['cintura']); ?></td>
                                                    <td><?= esc($Falda['cadera']); ?></td>
                                                    <td>
                                                        <div class="btn-group">
                                                            <a href="<?= base_url('editarFalda/' . $Falda['idCliente']); ?>"
                                                                class="btn btn-outline-primary">Editar</a>
                                                            <a href="#" class="btn btn-outline-danger"
                                                                onclick="confirmDelete(event, '<?= base_url('borrarFalda/' . $Falda['idCliente']); ?>');">Borrar</a>
                                                            <a href="<?= base_url('crearVenta?cliente=' . $Falda['idCliente'] . '&confeccion=4'); ?>"
                            ...
                            <div class="pagination-links">
                                <?= $paginacion->only(['search', 'orden'])->links('default', 'custom_pagination'); ?>
                            </div>
                        </div>
                    </div>
                </div>
