    ...
    <tr>
        ...
        <td>
            <div class="btn-group">
                ...
                <a href="#" class="btn btn-outline-danger" style="margin-right: 2px;" onclick="confirmDeleteDatos(event, '<?= base_url('borrartrajeFemenino/' . $TrajeFemenino['cliente_id']); ?>');">Borrar</a>
            </div>
        </td>
    </tr>
    <?php endforeach; ?>
