        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="card-title">Datos Traje Femenino</h1>

                            <!-- Formulario de búsqueda y orden -->
                            <form method="GET" action="<?= site_url('datosTrajeFemenino'); ?>">
                                <div class="row mb-3">
                                    <!-- Campo de búsqueda -->
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-3">
                                        <select name="orden" class="form-control">
                                            ...
                                            <option value="recientes" <?= ($orden ?? '') === 'recientes' ? 'selected' : ''; ?>>Recientes
                                            </option>
                                            <option value="antiguos" <?= ($orden ?? '') === 'antiguos' ? 'selected' : ''; ?>>Antiguos
                                            </option>
                                            <option value="nombre_asc" <?= ($orden ?? '') === 'nombre_asc' ? 'selected' : ''; ?>>Nombre A-Z
                                            </option>
                                            <option value="nombre_desc" <?= ($orden ?? '') === 'nombre_desc' ? 'selected' : ''; ?>>Nombre Z-A
                                            </option>
                                        </select>
                                    </div>
                                    <!-- Botones -->
                                    <div class="col-md-3">
                                        ...
                                        <a href="<?= site_url('datosTrajeFemenino'); ?>"
                            ...
                            <div class="table-responsive">
                                <table class="table table-dark">
                                    ...
                                    <tbody>
                                        <?php if (!empty($trajeFemeninos)): ?>
                                            <?php foreach ($trajeFemeninos as $traje): ?>
                                                <tr>
                                                    ...
                                                    <td><?= esc($traje['cintura']); ?></td>
                                                    <td><?= esc($traje['cadera']); ?></td>
                                                    <td><?= esc($traje['largoManga']); ?></td>
                                                    <td>
                                                        <div class="btn-group">
                                                            <a href="<?= base_url('editartrajeFemenino/' . $traje['idCliente']); ?>"
                                                                class="btn btn-outline-primary">Editar</a>
                                                            <a href="#" class="btn btn-outline-danger"
                                                                onclick="confirmDelete(event, '<?= base_url('borrartrajeFemenino/' . $traje['idCliente']); ?>');">Borrar</a>
                                                            <a href="<?= base_url('crearVenta?cliente=' . $traje['idCliente'] . '&confeccion=2'); ?>"
