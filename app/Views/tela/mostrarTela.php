    ...
    <div class="container-scroller">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
                <a class="sidebar-brand brand-logo" href="index.html"><img src="<?= base_url('img/logo.png') ?>"
                        alt="logo" /></a>
                <a class="sidebar-brand brand-logo-mini" href="index.html"><img
                        src="<?= base_url('img/miniLogo.png') ?>" /></a>
            </div>
            <ul class="nav">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="navbar p-0 fixed-top d-flex flex-row">
                <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
                    <a class="navbar-brand brand-logo-mini" href="<?= base_url('cliente') ?>"><img
                            src="<?= base_url('img/logo.png') ?>" alt="logo" /></a>
                </div>
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="container">
                        <div class="row">
                            <!-- Left Column: Tela Selection Grid -->
                            <div class="col-md-4 tela-grid">
                                <div class="row">
                                    <?php foreach ($telas as $tela): ?>
                                        <div class="col-md-4 mb-3 tela-item">
                                            <img src="<?= base_url('uploads/' . $tela['imagenTela']); ?>"
                                                alt="<?= esc($tela['nombre']); ?>" class="img-fluid rounded"
                                                onclick="selectTela('<?= base_url('uploads/' . $tela['imagenTraje']); ?>')">
                                            <p class="text-center mt-1"><?= esc($tela['nombre']); ?></p>
                                        </div>
                                    <?php endforeach; ?>
                                </div>
                            </div>

                            <!-- Right Column: Display Selected Traje -->
                            <div class="col-md-8 traje-display">
                                <img id="trajeImage" src="<?= base_url('uploads/' . $telas[0]['imagenTraje']); ?>"
                                    alt="Traje Seleccionado" class="img-fluid">
                            </div>
                        </div>
                    </div>

                    <script> function selectTela(trajeImageUrl) {
